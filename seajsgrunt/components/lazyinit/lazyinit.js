define('MOD_ROOT/lazyinit/lazyinit', function (require, exports, module) {
    ...
    function init() {
        ...
        lazyinit.bindFun($('.pop-recipes'), function () {
			...
			// console.log('@@');
			var $popRecipes = $('.pop-recipes');
			require.async('MOD_ROOT/poprecipes/poprecipes', function (poprecipes) {
				poprecipes.init($popRecipes);
			});
		});
		lazyinit.bindFun($('.pop-keywords'), function () {
			require.async('MOD_ROOT/popKeywords/popKeywords', function (poprecipes) {
				poprecipes.init();
			});
		});
    }
